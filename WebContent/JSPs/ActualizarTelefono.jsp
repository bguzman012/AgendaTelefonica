...
<link rel="stylesheet" type="text/css" href="/Pr-ctica-de-laboratorio-02-Servlets-JSP-y-JPA/css/main3.css">
</head>
<body>
	<header>
		...
		<section class="header">
			<div class="container">
				<div class="row">
					<div class="col-md-3">
						<a href="/Pr-ctica-de-laboratorio-02-Servlets-JSP-y-JPA/index.html"><img id="otra "
							src="/Pr-ctica-de-laboratorio-02-Servlets-JSP-y-JPA/img/tele.png" alt="Slider"
					...
					<div class="col-md-7">
						<ul class="nav navbar-nav">
							<li class="active"><a
								href="/Pr-ctica-de-laboratorio-02-Servlets-JSP-y-JPA/JSPs/CuentaPrincipal.jsp">PERFIL</a></li>
							<li><a href="/Pr-ctica-de-laboratorio-02-Servlets-JSP-y-JPA/JSPs/BuscarContacto.jsp">BUSCAR
									USUARIO</a></li>
		...
		<div class="container">
			<div class="limiter">
				<div class="container-table100">
					...
					<form
						action="/Pr-ctica-de-laboratorio-02-Servlets-JSP-y-JPA/ControladorTelefono?accion=buscar_telefono"
					...
					<form
						action="/Pr-ctica-de-laboratorio-02-Servlets-JSP-y-JPA/ControladorTelefono?accion=modificar_telefono"
