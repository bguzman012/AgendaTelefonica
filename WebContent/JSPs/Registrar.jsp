...
<link rel="stylesheet" href="/Pr-ctica-de-laboratorio-02-Servlets-JSP-y-JPA/Styles/styles2.css">
		...
		<section class="header-top">
			<div class="container">
				<div class="row">
					<div class="col-md-4">
						<ul>
							<li><a href="/Pr-ctica-de-laboratorio-02-Servlets-JSP-y-JPA/index.html">Inicio</a></li>
						</ul>
					</div>
					<div class="col-md-4">
						<div class="icon">
			...
			<div class="login">
				...
				<div class="login-screen">
					...
					<div class="login-form">
						<form action="/Pr-ctica-de-laboratorio-02-Servlets-JSP-y-JPA/ControladorRegistrar" method="post">
