...
<link
	...
	rel="stylesheet">
<link rel="stylesheet" href="/Pr-ctica-de-laboratorio-02-Servlets-JSP-y-JPA/css/bootstrap.css">
<link rel="stylesheet" href="/Pr-ctica-de-laboratorio-02-Servlets-JSP-y-JPA/css/font-awesome.min.css">
<link rel="stylesheet" href="/Pr-ctica-de-laboratorio-02-Servlets-JSP-y-JPA/Styles/style.css">
<link rel="stylesheet" href="/Pr-ctica-de-laboratorio-02-Servlets-JSP-y-JPA/Styles/InicioSesion.css">
<link rel="stylesheet" type="text/css" href="/Pr-ctica-de-laboratorio-02-Servlets-JSP-y-JPA/css/util.css">
<link rel="stylesheet" type="text/css" href="/Pr-ctica-de-laboratorio-02-Servlets-JSP-y-JPA/css/main2.css">
</head>
<body>
	<header>
		...
		<section class="header-top">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4">
						<div class="a-right">
							<a href="/Pr-ctica-de-laboratorio-02-Servlets-JSP-y-JPA/ControladorSesion?salir=1">
								<p>
		...
		<section class="header">
			<div class="container">
				<div class="row">
					<div class="col-md-3">
						<a href="/Pr-ctica-de-laboratorio-02-Servlets-JSP-y-JPA/index.html"><img id="otra " src="/Pr-ctica-de-laboratorio-02-Servlets-JSP-y-JPA/img/tele.png"
							alt="Slider"
					...
					<div class="col-md-7">
						<ul class="nav navbar-nav">
							...
							<li><a href="/Pr-ctica-de-laboratorio-02-Servlets-JSP-y-JPA/JSPs/BuscarContacto.jsp">BUSCAR USUARIO</a></li>
							<li><a href="/Pr-ctica-de-laboratorio-02-Servlets-JSP-y-JPA/JSPs/ActualizarTelefono.jsp">MODIFICAR INFORMACION PERSONAL</a></li>
		...
		<div class="container">
			<div class="limiter">
				<div class="container-table100">
					...
					<form action="/Pr-ctica-de-laboratorio-02-Servlets-JSP-y-JPA/ControladorTelefono?accion=crear_telefono" method="post"
						...
						<input class="mi" type="tel" name="cc" id="hola"
							...
							id="login-name" maxlength="10" value="${requestScope.er}">
						<div style="color: red; margin-left: 50px;">${requestScope.validacionTelefono}</div>
				...
				<div class="row">
					...
					<div class="col-md-8">
						<div class="footer_logo">
							<img src="/Pr-ctica-de-laboratorio-02-Servlets-JSP-y-JPA/img/fedex.png"> <img src="/Pr-ctica-de-laboratorio-02-Servlets-JSP-y-JPA/img/master-card.png">
							<img src="/Pr-ctica-de-laboratorio-02-Servlets-JSP-y-JPA/img/paypal.png"> <img src="/Pr-ctica-de-laboratorio-02-Servlets-JSP-y-JPA/img/visa.png"> <img
								src="/Pr-ctica-de-laboratorio-02-Servlets-JSP-y-JPA/img/american-express.png"> <img src="/Pr-ctica-de-laboratorio-02-Servlets-JSP-y-JPA/img/dhl.png">
						</div>
					</div>
				</div>
			</div>
